...
drop function if exists public.save_inventory_locations_batch(uuid, jsonb);
drop function if exists public.manage_inventory_location_group(uuid, text);
drop function if exists public.save_inventory_location_group(jsonb);
...
alter table public.inventory_locations drop constraint if exists inventory_locations_group_fkey;
alter table public.inventory_locations drop constraint if exists inventory_locations_system_type_check;
drop index if exists public.inventory_location_groups_workspace_name_active_idx;
alter table public.inventory_locations drop column if exists group_id;
alter table public.inventory_locations drop column if exists system_type;
drop table if exists public.inventory_location_groups;
