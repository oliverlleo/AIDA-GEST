...
BEGIN
    ...
    RETURN (
        WITH tickets_query AS (
            SELECT t.id, t.os_number, t.client_name, t.status, t.technician_id, e.name AS technician_name, t.entry_date, t.device_model, t.priority, t.deadline, t.analysis_deadline, t.defect_reported
