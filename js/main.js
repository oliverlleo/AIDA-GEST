                ...
                if (response) {
                    ...
                    if (response.items) {
                        ...
                        this.homeOps = {
                            ...
                            pendingTech: this.homeOperationalItems.filter(t => !t.is_outsourced && ['Aberto', 'Analise Tecnica', 'Andamento Reparo', 'Teste Final'].includes(t.status)),
                            outsourcedToSend: this.homeOperationalItems.filter(t => t.is_outsourced && t.status === 'Aberto'),
